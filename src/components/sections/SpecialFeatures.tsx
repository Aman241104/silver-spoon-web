    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link href="#" className="group relative h-[450px] md:h-[550px] overflow-hidden bg-[#fef5e7] flex flex-col items-center justify-center p-12 text-center border border-silver-100">
             <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="w-56 h-56 md:w-64 md:h-64 rounded-full bg-white shadow-2xl flex items-center justify-center p-4 border border-gold/10 relative overflow-hidden">
                   <Image 
                     src="https://images.unsplash.com/photo-1590731057692-bb202febc667?q=80&w=600&auto=format&fit=crop"
                     alt="Silver Idols"
                     fill
          ...
          <Link href="#" className="group relative h-[450px] md:h-[550px] overflow-hidden bg-[#fef5e7] flex flex-col items-center justify-center p-12 text-center border border-silver-100">
             <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="w-56 h-56 md:w-64 md:h-64 bg-white shadow-2xl flex items-center justify-center p-4 border border-gold/10 relative overflow-hidden">
                   <Image 
                     src="https://images.unsplash.com/photo-1589128777073-263566ae5e4d?q=80&w=600&auto=format&fit=crop"
                     alt="Silver Utensils"
                     fill
                     className="object-cover group-hover:scale-110 transition-transform duration-700"
                   />
