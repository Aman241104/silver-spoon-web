...
export const products: Product[] = [
  ...
  createProduct("gs-2", "POOJA THALI SET", "german-silver", "German Silver", "/images/products/pooja-thali-set.png", undefined, undefined, 1800),
  createProduct("gs-8", "DRY FRUIT DESINER TRAY", "german-silver", "German Silver", "/images/products/filigree-bowl.png", undefined, undefined, 3000),
  createProduct("gs-12", "HEART JEWELLERY BOX", "german-silver", "German Silver", "/images/products/heart-pearl-box.png", undefined, undefined, 3500),
  createProduct("gs-13", "SILVER RING BOX", "german-silver", "German Silver", "/images/products/silver-ring-box.png", undefined, undefined, 1500),
  createProduct("gs-14", "ROYAL FLORAL JAR", "german-silver", "German Silver", "/images/products/ornate-silver-jar.png", undefined, undefined, 5500),
  createProduct("gs-15", "ROYAL SWAN CUTLERY HOLDER", "german-silver", "German Silver", "/images/products/swan-cutlery-holder.png", undefined, undefined, 4500),
  createProduct("gs-16", "BUTTERFLY JEWELLERY BOX", "german-silver", "German Silver", "/images/products/butterfly-jewellery-box.png", undefined, undefined, 2800),
  createProduct("gs-17", "HEXAGONAL FLORAL BOX", "german-silver", "German Silver", "/images/products/hexagonal-floral-box.png", undefined, undefined, 2200),
  createProduct("gs-18", "FILIGREE DOME STAND", "german-silver", "German Silver", "/images/products/filigree-dome-stand.png", undefined, undefined, 1800),
  createProduct("gs-19", "ROYAL RECTANGULAR BOX", "german-silver", "German Silver", "/images/products/rectangular-royal-box.png", undefined, undefined, 4800),
  createProduct("gs-20", "SILVER FILIGREE BOTTLE SET", "german-silver", "German Silver", "/images/products/silver-filigree-bottle-set.png", undefined, undefined, 7500),
  createProduct("gs-21", "GREEN FLORAL VASE", "german-silver", "German Silver", "/images/products/green-floral-vase.png", undefined, undefined, 3500),
  createProduct("gs-22", "PEACOCK MUKHWAS JAR", "german-silver", "German Silver", "/images/products/peacock-mukhwas-jar.png", undefined, undefined, 4200),
  createProduct("gs-23", "DOUBLE JAR FILIGREE SET", "german-silver", "German Silver", "/images/products/double-jar-filigree-tray.png", undefined, undefined, 5800),
  createProduct("gs-24", "ROYAL BLACK & SILVER BOX", "german-silver", "German Silver", "/images/products/royal-black-silver-box.png", undefined, undefined, 3200),
  createProduct("gs-25", "LAUGHING BUDDHA GIFT SET", "german-silver", "German Silver", "/images/products/laughing-buddha-gift.png", undefined, undefined, 1200),
  createProduct("gs-26", "LOTUS ENAMEL BOWL", "german-silver", "German Silver", "/images/products/lotus-enamel-bowl-white.png", undefined, undefined, 1800),
  createProduct("gs-27", "ORANGE LOTUS ENAMEL BOWL", "german-silver", "German Silver", "/images/products/lotus-enamel-bowl-orange.png", undefined, undefined, 1800),
  createProduct("gs-28", "BLUE PEACOCK MUKHWAS JAR", "german-silver", "German Silver", "/images/products/peacock-mukhwas-jar-blue.png", undefined, undefined, 4200),
  createProduct("gs-29", "PEACOCK JAR TRAY SET", "german-silver", "German Silver", "/images/products/double-peacock-jar-tray.png", undefined, undefined, 8500),
