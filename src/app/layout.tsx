...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.silverspoonbyacj.com/images/hero-gifting.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://www.silverspoonbyacj.com/images/hero-gifting.jpg"],
  },
  icons: {
    icon: [
      ...
      <body className="bg-white text-charcoal font-sans antialiased selection:bg-silver-200 selection:text-charcoal">
        <WishlistProvider>
          <CartProvider>
            ...
            <Suspense><StickyWhatsApp /></Suspense>
          </CartProvider>
        </WishlistProvider>
      </body>
    </html>
